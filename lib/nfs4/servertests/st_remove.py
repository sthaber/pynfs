...
def testCfhFile(t, env):
    ...
    """
    c = env.c1
    res = c.remove_obj(env.opts.usefile, t.code)
...
def testCfhLink(t, env):
    ...
    """
    c = env.c1
    res = c.remove_obj(env.opts.uselink, t.code)
    check(res, NFS4ERR_NOTDIR, "REMOVE with non-dir cfh")
...
def testCfhBlock(t, env):
    ...
    """
    c = env.c1
    res = c.remove_obj(env.opts.useblock, t.code)
    check(res, NFS4ERR_NOTDIR, "REMOVE with non-dir cfh")
...
def testCfhChar(t, env):
    ...
    """
    c = env.c1
    res = c.remove_obj(env.opts.usechar, t.code)
    check(res, NFS4ERR_NOTDIR, "REMOVE with non-dir cfh")
...
def testCfhFifo(t, env):
    ...
    """
    c = env.c1
    res = c.remove_obj(env.opts.usefifo, t.code)
    check(res, NFS4ERR_NOTDIR, "REMOVE with non-dir cfh")
...
def testCfhSocket(t, env):
    ...
    """
    c = env.c1
    res = c.remove_obj(env.opts.usesocket, t.code)
    check(res, NFS4ERR_NOTDIR, "REMOVE with non-dir cfh")
