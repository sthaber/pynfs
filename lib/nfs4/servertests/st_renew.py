...
def testExpired(t, env):
    ...
    # ISILON: We've had problems with returning NFS4ERR_EXPIRED,
    # so we generally return STALE_CLIENTID or STALE_STATEID
    checklist(res, [NFS4ERR_EXPIRED, NFS4ERR_STALE_CLIENTID], "RENEW with expired lease")
