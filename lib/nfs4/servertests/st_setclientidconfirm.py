...
def testBadConfirm(t, env):
    ...
    # XXX ZACK: This seems like it should return STALE_CLIENTID. See RFC 3530,
    # section 14.2.34, "If the client does send a SETCLIENTID_CONFIRM for an
    # unconfirmed record" ...
    #check(res, msg="SETCLIENTID_CONFIRM with case not covered in RFC, "
    #      "seems most likely should do nothing and")
    check(res, NFS4ERR_STALE_CLIENTID, msg="SETCLIENTID_CONFIRM on deleted "
        "confirm is not returning STALE_CLIENTID")
