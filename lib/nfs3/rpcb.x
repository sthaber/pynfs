...
/* Port mapper protocol, taken from RFC 1057
 * Edited by Zack Kirsch, for consumption by pynfs
 */
         struct mapping {
            unsigned int prog;
            unsigned int vers;
	     ...
	     /* XXX ZACK Had to edit this structure */
         typedef struct {
            mapping map;
            pmaplist *next;
         } pmaplist;
...
struct rp__list {
 rpcb rpcb_map;
 rp__list *rpcb_next; /* XXX ZACK Removed struct */
};
...
struct rpcb_entry_list {
 ...
 rpcb_entry_list *rpcb_entry_next; /* XXX ZACK Removed struct */
};
...
struct rpcbs_addrlist {
 ...
 int failure;
 string netid<>;
 rpcbs_addrlist *next; /* XXX ZACK Removed struct */
};
...
struct rpcbs_rmtcalllist {
 ...
 string netid<>;
 rpcbs_rmtcalllist *next; /* XXX ZACK Removed struct */
};
...
/*
 * rpcbind procedures$a
 * XXX ZACK: PMAP_VERS taken from portmap protocol
 */
program RPCBPROG {
    version PMAP_VERS {
       void
 ...
 version RPCBVERS4 {
     ...
     */
     ...
     netbuf
     RPCBPROC_UADDR2TADDR(astring) = 7;
